...
import "./AttorneyCaseManagement.css";
...
const AttorneyCaseManagement = () => {
  ...
  const attorney_id = getUserIdFromToken();
  ...
  const handleView = () => {
    if (selectedRow) {
      navigate(`/attorney/case/view/${selectedRow.case_id}`);
      handleMenuClose();
    }
  };
                ...
                return (
                  <>
                    ...
                    >
                      ...
                      >
                        <Link
                          to={`/attorney/case/view/${row.case_id}`}
...
export default AttorneyCaseManagement;
