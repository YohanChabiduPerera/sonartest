...
import { GetDocuments, GetDocumentsByExpert, SearchDocument } from "../../apis/DocumentManagement";
import { useDispatch } from "react-redux";
import { setLoading } from "../../store/loaderSlice";
import { getUserIdFromToken } from "../../utils/auth";

const ExpertDocumentManagement = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const data = await GetDocumentsByExpert(getUserIdFromToken());
      setRows(data.data);
...
export default ExpertDocumentManagement;
