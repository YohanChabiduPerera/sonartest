...
import { GetCaseByAttorney, GetCaseByExpert } from "../../apis/CaseManagementAPI";
...
import { GetAttorney, GetExpert } from "../../apis/UserManagementAPI";
...
const ExpertDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await GetCaseByExpert(getUserIdFromToken());
  ...
  useEffect(() => {
    const fetchExpertData = async () => {
      dispatch(setLoading(true));
      try {
        const response = await GetExpert(getUserIdFromToken());
        console.log("Response: ", response.data.data);
        const fetchedExpert = response.data.data;
        setExperts(fetchedExpert);
...
const handleSeeMore =  () => {
  navigate(`/expert/case/view/expert/${getUserIdFromToken()}`)
}
