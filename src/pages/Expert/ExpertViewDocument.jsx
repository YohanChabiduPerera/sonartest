  ...
  useEffect(() => {
    ...
    const fetchDocumentData = async () => {
      try {
        ...
        dispatch(setLoading(false)); // Move here after setting the PDF file URL
      } catch (error) {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={4}>
          ...
          <TextField
            ...
            fullWidth
            variant="outlined"
            value={documentData.dateCreated}
            InputLabelProps={{ shrink: true }}
            disabled
            sx={{
              marginBottom: 3,
...
export default AttorneyViewDocument;
