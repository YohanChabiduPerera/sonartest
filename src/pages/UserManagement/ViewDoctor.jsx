...
import { DeleteDoctor, GetDoctor } from "../../apis/UserManagementAPI";
...
const ViewDoctor = () => {
  ...
  const handleOpenForm = () => {
    navigate(`/user-update/doctor/${doctor_id}`);
  };
  ...
  const handleDelete = async (event) => {
    ...
    try {
      const response = await DeleteDoctor(doctor_id);
      // console.log("Doctor  Deleted successfully:");
      dispatch(setLoading(false));
      navigate("/users");
    } catch (error) {
      // console.log("An error occurred while deleting the doctor.", error);
      dispatch(setLoading(false));
    }
