...
const ChatArea = () => {
  ...
  const handleSendMessage = useCallback(() => {
    ...
    // console.log("WebSocketManagerChat", WebSocketManagerChat.isConnected);
    // console.log("selectedPerson", selectedPerson);
    // console.log("userId", userId);
    // console.log("WebSocketManagerChat", WebSocketManagerChat);

    if (
      currentMessage.trim() !== "" &&
      WebSocketManagerChat.isConnected && // Check if the socket is connected
      selectedPerson &&
      userId &&
      WebSocketManagerChat.socket // Ensure the socket exists before sending
    ) {
      setIsLoading(true);
      const messageData = {
        action: "sendMessage",
        senderId: userId,
        receiverId: selectedPerson.id, // Ensure selectedPerson has an 'id' field
        messageText: currentMessage,
      };

      console.log("messageData", messageData);
      WebSocketManagerChat.socket.send(JSON.stringify(messageData)); // Send the message
